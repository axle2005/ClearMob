...
public class CommandStats implements CommandExecutor {
		...
		private final Text HEADER = Text.builder("-----------------------------------------------").color(TextColors.GRAY).build();
		    ...
		    throws CommandException
		  {
		    ...
		    {
		    	src.sendMessage(Text.of("- " + w.getName() + " (" + w.getEntities().size() + " entities, "+Iterables.size(w.getLoadedChunks()) + " loaded chunks)"));
		    }
		    src.sendMessage(this.HEADER);
